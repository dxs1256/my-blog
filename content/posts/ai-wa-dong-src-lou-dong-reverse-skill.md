...
categories:
  - 工具推荐
image: "https://bing.ee123.net/img/rand?seed=ai-wa-dong-src-lou-dong-reverse-skill"
---
[//]: # (notion-sync-id: ...)

上回介绍过 [reverse-skill](https://github.com/zhaoxuya520/reverse-skill)（26.7k Star）这个 AI 逆向工程技能包的整体架构。这次单说一个很多人关心的玩法：**用它挖 SRC 漏洞换赏金**。
...
<!-- ⟦ 已发布博客 让AI帮你挖SRC漏洞 reverse-skill src-hunter视角 ⟧ -->